...
export const cs = {
    ...
    'gui.menuBar.autoSaveManager.loadProject': 'Otevřít v editoru',
    ...
    'gui.menuBar.autoSaveManager.statusDeployed': 'Nasazeno',
    'gui.menuBar.autoSaveManager.draftSectionTitle': 'Projekty k úpravám a testování',
    'gui.menuBar.autoSaveManager.draftSectionDescription': 'Tyto projekty slouží k úpravám a testování. Neběží trvale.',
    'gui.menuBar.autoSaveManager.deployedSectionTitle': 'Projekty pro trvalé spuštění',
    'gui.menuBar.autoSaveManager.deployedSectionDescription': 'Tyto projekty běží trvale a ovládají AlbiLAB. Fungují i když zavřete prohlížeč, ale server musí zůstat zapnutý!',
    'gui.menuBar.autoSaveManager.noDraftProjects': 'Žádné projekty k úpravám',
    'gui.menuBar.autoSaveManager.noDeployedProjects': 'Žádné nasazené projekty',
    'gui.menuBar.autoSaveManager.runPermanently': 'Spustit trvale',
    'gui.menuBar.autoSaveManager.loadToEditor': 'Načíst do editoru',
    'gui.menuBar.autoSaveManager.confirmDeleteTitle': 'Smazat projekt?',
    'gui.menuBar.autoSaveManager.confirmDeleteDraft': 'Tímto smažete editační verzi projektu "{name}". Nasazená verze (pokud existuje) zůstane. Chcete pokračovat?',
    'gui.menuBar.autoSaveManager.confirmDeleteDeployed': 'Tímto smažete nasazenou verzi projektu "{name}". Projekt se zastaví a již nebude ovládat AlbiLAB. Chcete pokračovat?',
    'gui.menuBar.autoSaveManager.confirmLoadToEditor': 'Načtení tohoto projektu přepíše vaši aktuální práci v editoru. Pokud chcete zachovat svou aktuální práci, můžete ji nejdříve exportovat pomocí Soubor → Uložit do počítače. Chcete pokračovat?',
    'gui.menuBar.autoSaveManager.confirmLoadToEditorTitle': 'Načíst projekt do editoru?',
    'gui.menuBar.autoSaveManager.confirmYes': 'Ano, pokračovat',
    'gui.menuBar.autoSaveManager.confirmNo': 'Ne',
    'gui.menuBar.autoSaveManager.tooltip.dragProject': 'Přetáhněte pro přesunutí projektu mezi sekcemi',
    'gui.menuBar.autoSaveManager.tooltip.loadDeployedProject': 'Načte nasazenou verzi tohoto projektu do editoru. Tímto přepíšete vaši aktuální práci v editoru',
    'gui.menuBar.autoSaveManager.tooltip.deleteDraftProject': 'Smaže editační verzi projektu. Nasazená verze (pokud existuje) zůstane',
    'gui.menuBar.autoSaveManager.tooltip.deleteDeployedProject': 'Smaže nasazenou verzi projektu. Projekt se zastaví a již nebude ovládat AlbiLAB',
...
export const en = {
    ...
    'gui.menuBar.autoSaveManager.loadProject': 'Open in editor',
