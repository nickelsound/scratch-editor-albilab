...
const MODAL_ALBILAB_IP_PROMPT = 'albilabIPPrompt';
...
const openAlbilabIPPrompt = function () {
    return openModal(MODAL_ALBILAB_IP_PROMPT);
};
const closeAlbilabIPPrompt = function () {
    return closeModal(MODAL_ALBILAB_IP_PROMPT);
};
export {
    reducer as default,
